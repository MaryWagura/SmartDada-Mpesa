                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active text-align form-new" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <img src="mpesa.png" width="90%">
                            <form action="Pay.php" method="POST">
                            <div class="row register-form">
                                <div class="col-md-12">
                                    <form method="post">
           <label for="amount"><h1 style="color:white"><b>Input Amount</label><br><br></b></h1>
        <input type="text" class="form-control" id = "amount" name="amount" required><br><br> 
          <label for="phonenumber"><h1 style="color:white"><b>Input Your Phone Number</label><br><br></b></h1>
